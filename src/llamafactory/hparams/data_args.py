...
class DataArguments:
    ...
    """
    save_input_ids: bool = field(
        default=False,
        metadata={"help": "Whether or not to save the input_ids."},
    )
    infer_model_size: str = field(
        default="14m",
        metadata={"help": "The size of the model infer ponderer."},
    )
    load_from_pkl: Literal["original", "ponderer"] = field(
        default=None,
        metadata={"help": "Whether or not to load the input_ids from pkl."},
    )
    uniform_ratio: bool = field(
        default=False,
        metadata={"help": "Whether or not to uniform the ratio of tokens to select."},
    )
    target_percent: float = field(
        default=0.01,
        metadata={"help": "The percentage of tokens to select."},
    )
    ...
    should_save: bool = field(
        default=False,
        metadata={"help": "Whether or not to save the tokenized datasets."},
    )
    light_dataset: bool = field(
        default=False,
        metadata={"help": "Whether or not to use a light dataset."},
    )
