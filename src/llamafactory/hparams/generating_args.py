...
# https://github.com/huggingface/transformers/blob/v4.40.0/src/transformers/generation/configuration_utils.py
#
...
class GeneratingArguments:
    r"""
    Arguments pertaining to the generation.
    """
    do_sample: bool = field(
        default=True,
        metadata={"help": "Whether or not to sample."},
    )
    ...
    top_k: int = field(
        default=50,
        metadata={"help": "The number of highest probability tokens to keep for top-k filtering."},
    )
    num_beams: int = field(
        default=1,
